...
if ((temperature >= 80) && (rain = true))
  ...
  else ((temperature < 60) && (rain = true))
  console.log("It is " + temperature + " and raining. wear a rain jacket and carry an umbrella.")
...
for (let x = 9; (0 <= x) && (x < array.length); x--)
console.log(array[x]);
...
console. log("scores not high enough")
score++
}
